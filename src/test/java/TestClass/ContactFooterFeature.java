...
public class ContactFooterFeature extends BaseLib {
	...
	public void initialize()
	{
	  ...
	  test= extent.createTest("Verify the ContactFooter functionality");
	...
	{
		tcid="6: verify the contact footer";
		Login log= new Login(driver,test);
        log.login("pratiksha.damodar@legitquest.com", "lq@123");
        Contact_Footer footer= new Contact_Footer(driver,test);
		footer.click(BaseLib.driver);
