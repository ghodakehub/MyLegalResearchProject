...
public class JudgmentPrintPdfFeature extends BaseLib{
	...
	public void initialize()
	{
	  ...
	  test= extent.createTest("Judement PrintPDF feature");
	...
	
	{
        ...
        JudgmentPrintPdf note=new JudgmentPrintPdf(driver,test);
