...
public class LatestslegalNews extends BaseLib {
	...
	public void initialize()
	{
	  ...
	  test= extent.createTest("LatestLegalNewsPage");
	...
	
	{
		...
		test.log(Status.INFO,"verify LatestLegalNews");
		LatestLegalNews link =new LatestLegalNews (driver,test);
		link.latestlegalnewsfeature(BaseLib.driver);
