...
public class Mynewnotefunctionality extends BaseLib{
	...
	public void initialize()
	{
	  ...
	  test= extent.createTest("My NewNote functionality of Mynote module");
	...
	
	{
		...
		MyNoteNewNote note=new MyNoteNewNote (driver,test);
	     note.verifynewnote(BaseLib.driver);	
