...
public class JudgmentAddNote extends BaseLib {
	...
	public void initialize()
	{
	  ...
	  test= extent.createTest("Judgment Add notes test case");
	...
	
	{
		...
		JudgmentAddNotefunction note =new JudgmentAddNotefunction(driver,test);
