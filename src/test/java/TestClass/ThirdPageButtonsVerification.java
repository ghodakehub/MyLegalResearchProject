...
public class ThirdPageButtonsVerification extends BaseLib{
	...
	public void initialize()
	{
	  ...
	  test= extent.createTest("ThirdpagesButtons test case");
	...
	{
		tcid="6: Verifying the ThirdPagesButtons likes downloadjudgements, savebookmarks, nightmode & reportproblems";
		Login log= new Login(driver, test);
		log.login("pratiksha.damodar@legitquest.com","lq@123");
		Third_PageButton btns= new Third_PageButton (driver,test);
	   btns.thirdpagebuttonsverification(BaseLib.driver);	
