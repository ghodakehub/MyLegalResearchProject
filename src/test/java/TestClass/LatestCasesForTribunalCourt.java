...
public class LatestCasesForTribunalCourt extends BaseLib{
	...
	public void initialize()
	{
	  ...
	  test= extent.createTest("Latest cases  of Tribunal verification");
	...
	
	{
		...
		test.log(Status.INFO,"verify total no of Tribunalcases");
		LatestCasesTribunal case1=new LatestCasesTribunal (driver,test);
