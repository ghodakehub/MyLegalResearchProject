...
public class NotebookActionsfeature extends BaseLib{
	...
	public void initialize()
	{
	  ...
	  test= extent.createTest("Notebook OF MY Note Module");
	...
	
	{
	   ...
	   NotebookActions actnote=new NotebookActions (driver,test);
	  actnote.verifynotebookfunction(BaseLib.driver);	
