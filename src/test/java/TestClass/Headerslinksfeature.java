...
public class Headerslinksfeature extends BaseLib{
	;
	...
	@Test
	public void VerifyHeadersLinks() throws InterruptedException, IOException
	
	{
		Login log= new Login(driver,test);
        log.login("pratiksha.damodar@legitquest.com", "lq@123");
        Headerslinks opt=new Headerslinks (driver,test);
		opt.verifyheaderslinks(BaseLib.driver);
