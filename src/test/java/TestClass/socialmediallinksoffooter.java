...
public class socialmediallinksoffooter extends BaseLib {
	...
	public void initialize()
	{
	  ...
	  test= extent.createTest("Social media links like facebook , twitter, linkedin, insta, youtube");
	...
	{
		tcid="6: verify the Social medial links at footer";
		Login log= new Login(driver, test);
		log.login("pratiksha.damodar@legitquest.com","lq@123");
		Footersocialmedia media= new Footersocialmedia (driver,test);
	media.verifysocialmedialinks(BaseLib.driver);
