...
public class Mybookmarkfunctionlity extends BaseLib{
	...
	public void initialize()
	{
	  ...
	  test= extent.createTest("My bookmarks module test case");
	...
	
	{
		...
		MyBookmarks marks= new MyBookmarks (driver,test);
	marks.profilefunctionality(BaseLib.driver);	
	marks.verifytbale(BaseLib.driver);
