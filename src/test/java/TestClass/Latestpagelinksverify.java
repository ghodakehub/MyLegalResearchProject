...
public class Latestpagelinksverify extends BaseLib{
	...
	public void initialize()
	{
	  ...
	  test= extent.createTest("LatestLegalNewsbrokenlinks");
	...
	
	{
		...
		test.log(Status.INFO,"verify LatestLegalNewsbrokenlinks");
		LatestLegalPageBrokenLink2 link=new LatestLegalPageBrokenLink2 (driver,test);
		link.click();
