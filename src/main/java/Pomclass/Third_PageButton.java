...
public class Third_PageButton extends BasePage1 {
	...
	public Third_PageButton(WebDriver driver,ExtentTest test) {
		super(driver, test);
	}
	...
	download.click();
	Thread.sleep(3000);
	Actions action = new Actions(BaseLib.driver);
	...
	BaseLib.driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
