...
public class Trashofmynote extends BasePage1 {
	...
	public Trashofmynote(WebDriver driver,ExtentTest test) {
		super(driver, test);
	}
	...
	public void trashfeature() throws InterruptedException {
		...
		//	searchfilter.sendKeys("Testdata1");
		//	Thread.sleep(2000);
			
		/*	undobtnarrow.click();
			Thread.sleep(2000);
			
			String mesgg = textonundotrash.getText();
			System.out.println("message:"+mesgg);
			Thread.sleep(2000);
			...
			js2.executeScript("arguments[0].click();", pageno2);
			Thread.sleep(4000);
		
			
			JavascriptExecutor js3 = (JavascriptExecutor) BaseLib.driver;
			js3.executeScript("arguments[0].click();", nextbtnpage);
			Thread.sleep(4000);
		
			
			JavascriptExecutor js4 = (JavascriptExecutor) BaseLib.driver;
			js4.executeScript("arguments[0].click();", pageno3);
			Thread.sleep(4000);
		
						
			deleteofaction.click();
			Thread.sleep(2000);
