...
public class PaginationAtmyBookmarks extends BasePage1 {
	...
	public PaginationAtmyBookmarks(WebDriver driver,ExtentTest test) {
		super(driver, test);
	}
	...
	public void paginationverification(WebDriver driver) throws InterruptedException
	{
		...
		JavascriptExecutor js13 = (JavascriptExecutor) BaseLib.driver;
	...
	//	Thread.sleep(3000);
		...
		JavascriptExecutor js15 = (JavascriptExecutor) BaseLib.driver;
