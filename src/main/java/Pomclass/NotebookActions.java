...
public class NotebookActions extends BasePage1 {
	...
	public NotebookActions(WebDriver driver,ExtentTest test) {
		super(driver, test);
	}
	...
	driver.switchTo().frame(driver.findElement(By.xpath("//*[@id=\"cke_4_contents\"]/iframe")));
		...
		Library.sendKeys(driver,descriptionofnote , " Add description note of notebook ", "Hi , here I am adding case for High court cases under  created notebook");
		Thread.sleep(3000);
