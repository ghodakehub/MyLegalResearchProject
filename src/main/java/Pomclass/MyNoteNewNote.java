...
public class MyNoteNewNote extends BasePage1 {
	...
	public MyNoteNewNote(WebDriver driver,ExtentTest test) {
		super(driver, test);
	}
	...
	public void verifynewnote(WebDriver driver) throws InterruptedException
	{
		...
		titlename.sendKeys("Automation test1");
		Thread.sleep(2000);

	driver.switchTo().frame(driver.findElement(By.xpath("//*[@id=\"cke_3_contents\"]/iframe")));
	//addDescription.click();
	Library.sendKeys(driver, addDescription, "enter description", "Hi here I am testing this fuctionaltiy working fine or not by automation ");
		Thread.sleep(2000);
