...
public class judgmentshare extends BasePage1 {
	...
	public judgmentshare(WebDriver driver,ExtentTest test) {
		super(driver, test);
	}
	...
	@FindBy(xpath = "//*[@id=\"email_container\"]/div/label") // FB app page for judgment share
...
// Actions 	
	public void judgementshare(WebDriver driver) throws InterruptedException {
		...
		Thread.sleep(3000);
		SwitchWindow.switchWindowByIndex(BaseLib.driver, 3);
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		SwitchWindow.switchWindowByIndex(BaseLib.driver, 4);
		Thread.sleep(3000);

		// verifying the judgment has share with Facebook app or not
		String actualtext2 = FBApp.getText();
		String ExpectedText2 = "Email address or phone number:";
		...
		Thread.sleep(3000);
		twitter.click();
		SwitchWindow.switchWindowByIndex(BaseLib.driver, 5);
		Thread.sleep(3000);
		...
		Library.click(driver, linkdin, "click on linkdin");
				...
				SwitchWindow.switchWindowByIndex(BaseLib.driver, 6);
		Thread.sleep(3000);
